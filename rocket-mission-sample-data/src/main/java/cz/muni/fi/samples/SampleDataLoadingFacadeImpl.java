...
//        component2.setReadyDate(ZonedDateTime.now().plusDays(2));
    ...
    public void loadAllUsers() {
        ...
        user1.setPassword(DigestUtils.md5Hex("tralala123").toUpperCase());
        ...
        user2.setPassword(DigestUtils.md5Hex("tralala321").toUpperCase());
        ...
        user3.setPassword(DigestUtils.md5Hex("taspokeqw").toUpperCase());
        ...
        user4.setPassword(DigestUtils.md5Hex("bosspassword").toUpperCase());
