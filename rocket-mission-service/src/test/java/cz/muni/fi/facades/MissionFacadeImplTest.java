...
public class MissionFacadeImplTest {
    ...
    public void setUp() {
        ...
        given(missionMapper.createMissionDTOToMission(createMissionDTO)).willReturn(mission);
    ...
    public void testFindAllMissionsWithProgress() {
        ...
        given(missionMapper.missionsToMissionDTOs(missionInProgressList)).willReturn(missionInProgressDTOList);
    ...
    public void testUpdateMission() {
        ...
        given(missionMapper.updateMissionDTOToMission(updateMissionDTO)).willReturn(mission1);
